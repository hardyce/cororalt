...
/**
 * Get the difference of two (numeric) nodes, i.e. node1 - node2, and bind the 
        ...
        if (n1.isLiteral() && n2.isLiteral()) {
            ...
            if (NumberUtil.isNumber(v1) && NumberUtil.isNumber(v2)) {                
                ...
                ||  v2 instanceof Float || v2 instanceof Double) {
                    ...
                    diff = Util.makeDoubleNode(dv1 - dv2);
                } else {
                    long lv1 = Long.parseLong(v1.toString());
                    long lv2 = Long.parseLong(v2.toString());
                    diff = Util.makeLongNode(lv1 - lv2);
                }
                return env.bind(args[2], diff);
            }
        }
