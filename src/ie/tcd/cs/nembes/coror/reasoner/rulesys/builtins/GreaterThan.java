...
/**
 * Greater than. It removes the support to  the comparison of XSDDatetime, 
 * but adds in the support for the comparison of 
 * anonnymous nodes assigned to literals.
 * @author x61
 */
